...
During the development of the blog, I faced many problems and challenges. And by the way, I’ll write about them in this blog with the tag [#my_blog](https://romaskydan.com/tags/blog). So, if you’re interested in following my progress in creating the blog, check out the tag or simply visit the [project blog page](/projects/blog).
